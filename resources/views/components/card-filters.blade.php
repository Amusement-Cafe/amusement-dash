@props(['collections' => [], 'tags' => [], 'sortDesc' => true, 'hidePromos' => false])

<div class="glass-panel" style="padding: 1.5rem; margin-bottom: 2rem; display: flex; flex-direction: column; gap: 1.5rem;">
    ...
    <div style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: flex-end; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.05);">
        ...
        <button wire:click="$toggle('sortDesc')" class="btn btn-secondary" style="height: 42px; display: flex; align-items: center; gap: 0.5rem; padding: 0 1rem;">
            @if($sortDesc)
        ...
        <button wire:click="$toggle('hidePromos')" class="btn {{ $hidePromos ? 'btn-primary' : 'btn-secondary' }}" style="height: 42px; display: flex; align-items: center; gap: 0.5rem; padding: 0 1rem; transition: background 0.2s;">
            @if($hidePromos)
    ...
    <div style="padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.05);">
        ...
        <div style="display: flex; gap: 0.5rem; align-items: center; flex-wrap: wrap;">
            <form wire:submit.prevent="addTag" style="display: flex; gap: 0.5rem; margin: 0;">
                ...
                <button type="submit" class="btn btn-secondary" style="padding: 0.4rem 1rem;"><i class="ph-bold ph-plus"></i> Add</button>
            </form>
